...
public class PacketResearchCreativeGrant {
    private final ResourceLocation research;

    public PacketResearchCreativeGrant(ResourceLocation string)
    {
        this.research = string;
    }
    public PacketResearchCreativeGrant(FriendlyByteBuf buf)
    {
