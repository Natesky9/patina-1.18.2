...
public class CrystalFortisArmorModel<T extends Entity> extends HumanoidModel<LivingEntity> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation
			.fromNamespaceAndPath("modid", "crystal_fortis_armor"), "main");

	public CrystalFortisArmorModel(ModelPart root) {
		super(root);
	}
