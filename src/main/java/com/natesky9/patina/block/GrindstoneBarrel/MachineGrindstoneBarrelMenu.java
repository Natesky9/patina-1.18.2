...
public class MachineGrindstoneBarrelMenu extends AbstractContainerMenu {
    ...
    // CREDIT GOES TO: diesieben07 | https://github.com/diesieben07/SevenCommons
        ...
        private static final int TE_INVENTORY_SLOT_COUNT = MachineGrindstoneBarrelEntity.slots;  // must be the number of slots you have!
    ...
    public boolean stillValid(Player pPlayer)
    {
        return stillValid(ContainerLevelAccess.create(level,blockEntity.getBlockPos()),
                pPlayer, ModBlocks.MACHINE_GRINDSTONE_BARREL.get());
    }
