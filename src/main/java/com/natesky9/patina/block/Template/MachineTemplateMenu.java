...
public class MachineTemplateMenu extends AbstractContainerMenu {
    private final MachineTemplateEntity blockEntity;
    ...
    {
        super(ModMenuTypes.MACHINE_TEMPLATE_MENU.get(), pContainerId);
