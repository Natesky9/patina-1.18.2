...
public class FragmentSmithingTemplateItem extends SmithingTemplateItem {
    ...
    public FragmentSmithingTemplateItem(Component p_266834_, Component p_267043_, Component p_267048_, Component p_267278_, Component p_267090_, List<ResourceLocation> p_266755_, List<ResourceLocation> p_267060_) {
        super(p_266834_, p_267043_, p_267048_, p_267278_, p_267090_, p_266755_, p_267060_);
    }
    public static FragmentSmithingTemplateItem makeFragment()
    {
        ...
        return new FragmentSmithingTemplateItem(component1,component2,component3,component4,component5,createList(),createList());
    }
